...
import StickyFooter from './StickyTextBox.jsx';
...
export default function PersistentDrawerLeft({chatId}) {
  ...
  return (
    <Box sx={{ display: 'fixed' }}>
        ...
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={openModelSelect} sx={{ p: 0 }}>
            ...
            <Menu
              ...
              open={Boolean(modelSelect)}
              onClose={closeModelSelect}
            >
              <MenuItem>
                <Typography fontSize={'medium'}>Models</Typography>
              </MenuItem>
              {models.map((models) => (
                <MenuItem sx={{mr:2}} key={models} onClick={closeModelSelect}>
                  <ListItemAvatar>
                    <Avatar sx={{ width: 30, height: 30 }}>
                      <AutoAwesomeIcon fontSize="small"/>
                    </Avatar>
                  </ListItemAvatar>
                  <ListItemText primary={models} secondary="Jan 9, 2014" />
                </MenuItem>
              ))}
            </Menu>
          </Box>
      ...
      <Main open={open}>
        <DrawerHeader/>
        <MessageLine chatId={chatId} />
        <StickyFooter drawerOpen={open} />
      </Main>  
    </Box>
  );
}
